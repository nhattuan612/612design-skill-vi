...
1. Đọc sổ nguồn skill. Với mỗi repo, lấy link chính xác, branch/ref, danh sách path, key/prefix, vị trí cài và các tuỳ biến đã ghi. Không suy đoán repo từ tên thư mục nếu sổ nguồn có dữ liệu khác.
...
6. Kiểm tra drift của bản cài: source link, branch/ref, số skill, tên skill, key/prefix, tên Việt hoá, mô tả Việt hoá, nội dung body, resource files và metadata UI.
...
4. So sánh thay đổi lần cuối. Nếu có sửa local trong body, script, reference hoặc asset, không âm thầm ghi đè; báo conflict và hỏi giữ local, nhận upstream hay hợp nhất.
5. Cài hoặc thay thế bản upstream tối thiểu. Giữ key/prefix đã lưu, sau đó áp dụng lại tên Việt hoá và mô tả Việt hoá. Không đổi nội dung body chỉ để “đồng bộ tên”.
...
- Tên skill dùng chữ thường, số và dấu gạch ngang, tối đa 63 ký tự; tên hiển thị có dạng `key-mo-ta-ngan`.
...
1. Kết luận ngắn: không đổi, có cập nhật, bị chặn hay cần quyết định.
