...
- Đọc `${CODEX_HOME:-$HOME/.codex}/skill-sources.md` nếu có để nhận biết repo ngoài, nguồn GitHub, key/icon đã lưu và skill đã được QLSKVN Việt hoá.
...
| `🟦 QLSKVN đã chỉnh` | Có nguồn trong sổ và dấu hiệu tên/mô tả/icon Việt hoá QLSKVN. | Bảo toàn tuỳ biến khi cập nhật/reset. |
| `⚪ Nguyên gốc` | Có nguồn theo dõi nhưng chưa có dấu hiệu QLSKVN chỉnh. | Theo dõi bình thường. |
